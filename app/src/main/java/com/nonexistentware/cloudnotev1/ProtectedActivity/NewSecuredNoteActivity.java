...
public class NewSecuredNoteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_secured_note2);

        noteTitle = findViewById(R.id.title_secured_note_new_activity);
        noteBody = findViewById(R.id.body_secured_note_new_activity);

        saveBtn = findViewById(R.id.new_secured_note_activity_btn);
        //mic
        titleMic = findViewById(R.id.new_secured_note_title_mic_btn);
        bodyMic = findViewById(R.id.new_secured_note_body_mic_btn);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(this, SecuredMainActivity.class));
        finish();
    }
}